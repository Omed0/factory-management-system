...
export const createSaleSchema = z.object({
    ...
    saleNumber: z.string().regex(/^[\u0600-\u06FF\uFB50-\uFDFF\uFE70-\uFEFFa-zA-Z0-9\s-]+$/, "شیوازی نوسینی ناوی وەصڵ بگۆڕە"),
...
export const updateProductSaleSchema = createProductSaleSchema.partial()
    .and(z.object({
        id: z.number().int().positive(),
    }));
...
export const updatePaidLoanSaleSchema = createPaidLoanSaleSchema.partial()
    .and(z.object({
        id: z.number().int().positive(),
    }));

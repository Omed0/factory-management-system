...
export async function getCompanyListPurchaseActions(id: number, trashed: boolean = false) {
...
export async function createCompanyPurchaseActions(data: CreateCompanyPurchase) {
...
export async function updateCompanyPurchaseActions(data: UpdateCompanyPurchase) {
...
export async function deleteCompanyPurchaseActions(id: number, companyId: number) {
...
export async function restoreCompanyPurchaseActions(id: number, companyId: number) {
...
export async function forceDeleteCompanyPurchaseActions(id: number, companyId: number) {
...
export async function getOneCompanyPurchaseInfoActions(id: number, companyPurchaseId: number) {
    const companyPurchaseInfo = await getOneCompanyPurchaseInfo(id, companyPurchaseId)
...
export async function getListCompanyPurchaseInfoActions(companyPurchaseId: number) {
    const companyPurchaseInfo = await getListCompanyPurchaseInfo(companyPurchaseId)
    if (companyPurchaseInfo === null || "error" in companyPurchaseInfo) {
        return {
            success: false,
            message: companyPurchaseInfo?.error
...
export async function createCompanyPurchaseInfoActions(data: CreateCompanyPurchaseInfo) {

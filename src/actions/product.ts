...
import {
    createProduct, deleteManyProduct, deleteProduct, forceDeleteManyProduct,
    forceDeleteProduct, getListProduct, getOneProduct, restoreManyProduct,
    restoreProduct, updateProduct
...
export async function getListProductActions({ isTrash }: { isTrash?: boolean }) {

...
import {
    ...
    createSaleForCustomer, decreaseQuantitySaleItem, deletePaidLoanSaleList, deleteProductSaleItem,
    deleteSaleForCustomer, discountForSaleInvoice, finishSaleInvoice, forceDeleteSaleForCustomer,
    getCustomerListSale, getCustomerOneSale, getPaidLoanSaleList, getProductSaleList,
    increaseQuantitySaleItem,
    restoreSaleForCustomer, updateSaleForCustomer
} from "@/server/access-layer/sale"
import {
    CreatePaidLoanSale, CreateProductSale, CreateSale,
    UpdateSale
...
export async function getCustomerListSaleActions(customerId: number, isTrash: boolean = false) {
...
export async function deleteSaleForCustomerActions(id: any, customerId: number) {
...
export async function restoreSaleForCustomerActions(id: any, customerId: number) {
...
export async function forceDeleteSaleForCustomerActions(id: any, customerId: number) {
...
export async function getProductSaleListActions(saleId: number, customerId: number) {
...
export async function increaseProductQuantityActions(id: number, amount: number) {
...
export async function decreaseProductQuantityActions(id: number, amount: number) {
...
export async function deletePaidLoanSaleListActions(id: number, saleId: number) {

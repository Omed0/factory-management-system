...
const completeSetup = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    await admin
      .from("dollar")
      .update({ price: data.default_dollar_rate })
      .eq("id", 1);
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <TextField
                  form={form}
                  name="base_currency"
                  label={t("setup.currencyCode")}
                  placeholder="IQD"
                />
                <TextField
                  form={form}
                  name="default_dollar_rate"
                  label={t("setup.usdRate")}
                  type="number"
                  required
                />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-6">
                <ColorPicker
                  form={form}
                  name="primary_color"
                  label={t("setup.primaryColor")}
                />
                <ColorPicker
                  form={form}
                  name="accent_color"
                  label={t("setup.accentColor")}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <form.Subscribe selector={(s) => s.isSubmitting}>
            {(submitting) => (
              ...
              >
                ...
                {submitting
                  ? t("setup.creatingFactory")
                  : t("setup.createFactory")}
              </Button>
            )}
          </form.Subscribe>
        </form>

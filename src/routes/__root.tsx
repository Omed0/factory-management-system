  ...
  head: ({ loaderData: settings }) => ({
    ...
    links: [
      ...
      ...(settings?.favicon_url
        ? [{ rel: "icon", href: settings.favicon_url }]
        : []),
    ],
  }),
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-4 bg-background">
      <div className="w-full max-w-md rounded-xl border bg-card text-card-foreground shadow p-8 text-center flex flex-col items-center">
        ...
        <h3 className="font-semibold tracking-tight text-2xl mb-2">
        ...
        <button
          ...
          className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full max-w-50"
        >
          {t("errors.goBack")}
        </button>
      </div>
